...
export default function ChampionsLeaguePage() {
  const seasons = [
    { year: "2025/26", winner: "TBD", status: "Ongoing" },
    { year: "2024/25", winner: "TBD", status: "Completed" },
    { year: "2023/24", winner: "TBD", status: "Completed" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-black text-white py-20 px-6 border-b-4 border-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-6xl md:text-7xl font-bold mb-4">CHAMPIONS LEAGUE</h1>
            ...
            {seasons.map((season) => (
              <div key={season.year} className="bg-black text-white rounded p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="border-t border-gray-700 pt-4">
                  ...
                  <p className="text-2xl font-bold text-white group-hover:text-gray-200 transition-colors">{season.winner}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 bg-black text-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl font-bold mb-16">ELITE COMPETITION</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white bg-opacity-5 rounded-lg p-8 hover:bg-opacity-10 transition-all duration-300 transform hover:-translate-y-2">
              <h3 className="text-2xl font-bold mb-4">⭐ TOP TEAMS</h3>
              <p className="text-gray-300">
                Only the best teams qualify. Compete against the elite.
              </p>
            </div>
            <div className="bg-white bg-opacity-5 rounded-lg p-8 hover:bg-opacity-10 transition-all duration-300 transform hover:-translate-y-2">
              <h3 className="text-2xl font-bold mb-4">🌙 MIDWEEK MAGIC</h3>
              <p className="text-gray-300">
                Evening fixtures under the lights create an unforgettable atmosphere.
              </p>
            </div>
            <div className="bg-white bg-opacity-5 rounded-lg p-8 hover:bg-opacity-10 transition-all duration-300 transform hover:-translate-y-2">
              <h3 className="text-2xl font-bold mb-4">🏆 GLORY</h3>
              <p className="text-gray-300">
                The most prestigious trophy. European glory awaits.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-bold mb-6 text-black">QUALIFY FOR GLORY</h2>
          <p className="text-xl mb-8 text-gray-700">
            Earn your place among the elite teams in the Champions League.
          </p>
          <a
